...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'context_processors.notification_cp.notification_processor',
            ],
        },
    },
]
...
# Memcached (Recommended for Performance)
CACHES = {
    "default": {
...
LOGGING = {
    ...
    'root': {
        ...
        'level': 'DEBUG',  # Use INFO or WARNING in production
    },
    'loggers': {
        'django': {
        ...
        'user': {  # 👈 Optional: your app-specific logger
            'handlers': ['console', 'file'],
            'level': 'DEBUG',
            'propagate': False,
        },
